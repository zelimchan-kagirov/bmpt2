    ...
    >
      <div class="trainer-card">
        ...
        <div class="info">
          ...
          <p>
            Country <span class="personal-info">({{ cardInfo.country }})</span>
          </p>
          <p>
...
export default {
  ...
  computed: {
    trainers() {
      return this.$store.getters["getDietitians"];
    },
  },
  methods: {
    giveRate() {
  ...
  // mounted() {
  //   this.$store.dispatch("setTreaners", [
  //     {
  //       id: 1,
  //       img: require("../assets/img/all-trainers/lisa.png"),
